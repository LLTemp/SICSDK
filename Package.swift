...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "sic-sdk-binary", url: "https://raw.githubusercontent.com/LLTemp/sic-sdk/1.5.6/SicSdkIos.xcframework.zip", checksum: "8327576b3dd28de91c81606726e0cb97894a7ead8efeb08057b5b20614085f9d")
    ]
)
