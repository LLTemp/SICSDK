...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget( name: "sic-sdk-binary",url: "https://raw.githubusercontent.com/LLTemp/sic-sdk/1.5.5/SicSdkIos.xcframework.zip",checksum: "5aa0e13656613156acb65f5fb44fd6a35376ad07d462ccb646e49a5183267555")
    ]
)
